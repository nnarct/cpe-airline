          ...
          return (
            <div key={i} className="border bg-gray-100 p-2 m-1">
              <ul>
                          ...
                          <ul className="pl-4">
                            ...
                            <li>
                              ...
                              <ul className="pl-4">
                                ...
                                <li>iataCode: {segment.departure.iataCode}</li>
                              </ul>
                ...
                <li>lastTicketingDateTime : {flight.lastTicketingDateTime}</li>
                <li>
                  nonHomogeneous : {flight.nonHomogeneous ? "true" : "false"}
                </li>
                <li>numberOfBookableSeats : {flight.numberOfBookableSeats}</li>
