  ...
  Swal.fire({
    ...
    <form>
      <div class="flex items-center justify-center ">
                ...
                <input id="FirstName" class="w-full md:w-4/5 px-2 py-1.5 active:ring rounded border my-2" placeholder="FirstName" value="${info?.FirstName}">
              </div>
              <div class="flex items-center justify-center py-2.5">
                <label htmlFor="LastName" class="w-24 block">LastName</label>
                <input id="LastName" class="w-full md:w-4/5 px-2 py-2.5 active:ring rounded border" placeholder="LastName" value="${info?.LastName}">
              </div>
              </div>
              <div class="flex items-center justify-center">
              <label for="Email" class="w-24 block">Email</label>
              <input type="email" class="w-full md:w-4/5 px-2 py-1.5 active:ring rounded border my-2" id="Email" value=${info?.Email}>
            </div>
            <div class="flex items-center justify-center">
              <label for="TelNo" class="w-24 block">TelNo</label>
              <input type="text" class="w-full md:w-4/5 px-2 py-1.5 active:ring rounded border my-2" id="TelNo" value="${info.TelNo}">
            </div>
    </form>    
    `,
